...
## Отклонения от плана
Мой ленивый мозг, который напуганный пуллами и коммитами в 2016, решил сделать задание немного иначе.  После клонирования, я продолжила работать в git репозитории через интерфейс, а не в командной строке.    
